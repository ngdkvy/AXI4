...
module tb_axi_system;
    ...
    initial begin
        ...
        //WRITE
        // Testcase 1: FIXED, awlen = 1 beat, awsize = 1 byte
        ...
        // Testcase 2: FIXED, awlen = 4 beat , awsize = 2 byte
...
//         Testcase 3: FIXED, awlen = 1 beat , awsize = 4 byte
...
//        input_wr_data  = 32'h12345678;
        ...
        // Testcase 4: INCR, awlen = 3 beat, awsize = 2 byte
...
//        input_wr_data  = 32'h22161043;
        ...
        // Testcase 5: INCR, awlen = 3 beat, awsize = 4 byte
...
//        input_wr_data  = 32'h22161043;
        ...
        // Testcase 6: WRAP, awlen = 14 beat, awsize = 1 byte
//        input_wr_addr  = 32'd0000_2578;
...
//        input_wr_data  = 32'h45679123;
        ...
        // Testcase 7: WRAP, awlen = 11 beat, awsize = 4 byte
...
//        input_wr_data  = 32'h45679123;
        ...
        // Testcase 8: FIXED, awlen = 1 beat , awsize = 4 byte, error address
...
//        input_wr_data  = 32'h12345678;
        ...
        forever #100 input_wr_valid = ~input_wr_valid;
            //READ
//         Testcase 9: FIXED, awlen = 1 beat, awsize = 1 byte
...
//        input_re_data  = 32'h45679123;
        ...
        // Testcase 10: FIXED, awlen = 4 beat, awsize = 2 byte
//        input_re_addr  = 32'd0001_5000;
...
//        input_re_data  = 32'h45679123;
        ...
        // Testcase 11: INCR, awlen = 3 beat, awsize = 2 byte
...
//        input_re_data  = 32'h87654321;
        ...
        // Testcase 12: INCR, awlen = 3 beat, awsize = 4 byte
...
//        input_re_data  = 32'h87654321;
        ...
        // Testcase 13: WRAP, awlen = 14 beat, awsize = 1 byte
//        input_re_addr  = 32'd0000_2578;
...
//        input_re_data  = 32'h56217895;
        ...
        // Testcase 14: WRAP, awlen = 11 beat, awsize = 4 byte
//        input_re_addr  = 32'd0001_5000;
...
//        input_re_data  = 32'h56217895;
        ...
        // Testcase 15: FIXED, awlen = 1 beat , awsize = 4 byte, error address
