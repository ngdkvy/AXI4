        ...
        begin
            case (wr_st)
                ...
                WR_DATA: begin
                            ...
                            begin
                                case (wr_burst_reg)
                                     FIXED: mem[wr_addr_reg] <= wdata;
                                     INCR: begin
                                            case (wr_awsize_reg)
                                                3'b000: begin
                                                            mem[wr_addr_reg] <= {mem[wr_addr_reg][31:8], wdata[7:0]};   // 1 byte
                                                            wr_addr_reg <= wr_addr_reg + 1;
                                                        end
                                                3'b001: begin
                                                            mem[wr_addr_reg] <= {mem[wr_addr_reg][31:16], wdata[15:0]};  // 2 byte
                                                            wr_addr_reg <= wr_addr_reg + 2;
                                                        end
                                                3'b010: begin
                                                            mem[wr_addr_reg] <= wdata[31:0];                     // 4 byte
                                                            wr_addr_reg <= wr_addr_reg + 4;
                                                        end
                                                default: begin
                                                            mem[wr_addr_reg] <= wdata; // fallback
                                                            wr_addr_reg <= wr_addr_reg + 4;
                                                         end
                                            endcase
                                           end
